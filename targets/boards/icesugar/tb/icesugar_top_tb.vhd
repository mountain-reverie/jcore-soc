...
architecture sim of icesugar_top_tb is
  ...
  -- free-running PORTB output, ~40 MHz (12.5 ns half-period, see
  -- sb_pll40_2_pad_sim.vhd) -- one Manchester half-bit slot is two clk_eth
  -- cycles (the phy retimed to 40 MHz), same convention as eth_tx_phy_tb.
  -- The tb decodes in real time (HALF_BIT = 50 ns), independent of the cycle count.
