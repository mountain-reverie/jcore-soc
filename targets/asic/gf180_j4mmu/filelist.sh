...
# core, ROM decode, id-cache -- see design.yaml). Adapted from
...
FILES=(
  ...
  # j4-rom variant decode table + cpu_synth config (from design.yaml's
  # model:j4 decode:rom -- see cpu_synth_files.list, regenerated by soc_gen).
  $CPU/decode/decode_table_rom.vhd
  $CPU/decode/decode_table_rom_config.vhd
  $CPU/synth/cpu_synth_j4_rom_config.vhd
