...
-- RAM with 1 read/write port, sync reads and writes, 24 bits wide with 3 8-bit
-- byte write select inputs, and 64 entries deep.
component ram_3x8x64_1rw is
  port (
    rst : in  std_logic;
    clk : in  std_logic;
    en  : in  std_logic;
    ...
    a   : in  std_logic_vector( 5 downto 0);
    dw  : in  std_logic_vector(23 downto 0);
    dr  : out std_logic_vector(23 downto 0);
    margin : in std_logic_vector(1 downto 0));
end component;
...
-- RAM with 2 read/write ports, sync reads and writes, 16 bits wide with 2 8-bit
-- byte write select inputs, and 512 entries deep.
component ram_2x8x512_2rw is
  port (
    rst0 : in  std_logic;
    clk0 : in  std_logic;
    en0  : in  std_logic;
