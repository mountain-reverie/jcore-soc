-- Models a 16x64 RAM with 1 read/write port.
...
architecture sim of ram_2x8x64_1rw is
...
begin
  ...
  begin
    ...
    if is_x(en) then
      assert false
        report "RAM 2x8x64 1rw EN UNKNOWN"
        severity WARNING;
    elsif is_x(wr) then
      assert false
        report "RAM 2x8x64 1rw WR UNKNOWN"
        severity WARNING;
    elsif is_x(we) then
      assert false
        report "RAM 2x8x64 1rw WE UNKNOWN"
        severity WARNING;
    elsif is_x(a) then
      assert false
        report "RAM 2x8x64 1rw ADDRESS UNKNOWN"
        severity WARNING;
    elsif is_x(dw) then
      assert false
        report "RAM 2x8x64 1rw DATAWRITE UNKNOWN"
        severity WARNING;
    else
