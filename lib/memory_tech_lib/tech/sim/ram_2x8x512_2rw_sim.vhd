...
architecture sim of ram_2x8x512_2rw is
...
begin
  ...
  begin
    ...
    if is_x(en0) then
      assert false
        report "RAM 2x8x512 2rw EN0 UNKNOWN"
        severity WARNING;
    elsif is_x(wr0) then
      assert false
        report "RAM 2x8x512 2rw WR0 UNKNOWN"
        severity WARNING;
    elsif is_x(we0) then
      assert false
        report "RAM 2x8x512 2rw WE0 UNKNOWN"
        severity WARNING;
    elsif is_x(a0) then
      assert false
        report "RAM 2x8x512 2rw ADDRESS0 UNKNOWN"
        severity WARNING;
    elsif is_x(dw0) then
      assert false
        report "RAM 2x8x512 2rw DATAWRITE0 UNKNOWN"
        severity WARNING;
    else
  ...
  begin
    ...
    if is_x(en1) then
      assert false
        report "RAM 2x8x512 2rw EN1 UNKNOWN"
        severity WARNING;
    elsif is_x(wr1) then
      assert false
        report "RAM 2x8x512 2rw WR1 UNKNOWN"
        severity WARNING;
    elsif is_x(we1) then
      assert false
        report "RAM 2x8x512 2rw WE1 UNKNOWN"
        severity WARNING;
    elsif is_x(a1) then
      assert false
        report "RAM 2x8x512 2rw ADDRESS1 UNKNOWN"
        severity WARNING;
    elsif is_x(dw1) then
      assert false
        report "RAM 2x8x512 2rw DATAWRITE1 UNKNOWN"
        severity WARNING;
    else
