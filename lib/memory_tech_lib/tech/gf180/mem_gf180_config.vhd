...
-- (sim) counterpart this mirrors). The macros with a real tech/gf180 vendor
-- arch (ram_2x8x256_1rw/ram_2x8x2048_2rw -- the 8 KB cache tag/data macros,
-- and ram_3x8x64_1rw/ram_2x8x512_2rw -- the Task 6 2 KB cache tag/data
    ...
    for rows
      ...
      for genram_3x8x64
        for all : ram_3x8x64_1rw
          use entity work.ram_3x8x64_1rw(gf180);
        end for;
      end for;
    end for;
  end for;
    ...
    for rows
      ...
      for genram_2x8x512
        for all : ram_2x8x512_2rw
          use entity work.ram_2x8x512_2rw(gf180);
        end for;
      end for;
    end for;
  end for;
